...
class OfferModel {
  ...
  OfferModel copyWith({
    ...
    String? department,
    List<OfferDetailModel>? details,
    String? distributionChannel,
    double? documentLimit,
    String? documentType,
    ...
    String? refuseExplanation,
    String? refuseReason,
    String? salesDistributionChannel,
    String? salesGroup,
    String? salesOrganization,
    String? totalMeasureUnit,
    String? userType,
    String? userTypeCode,
    ...
    return OfferModel(
      ...
      debt: debt ?? this.debt,
      debtCurrency: debtCurrency ?? this.debtCurrency,
      ...
      refuseExplanation: refuseExplanation ?? this.refuseExplanation,
      refuseReason: refuseReason ?? this.refuseReason,
      salesDistributionChannel: salesDistributionChannel ?? this.salesDistributionChannel,
      salesGroup: salesGroup ?? this.salesGroup,
      salesOrganization: salesOrganization ?? this.salesOrganization,
      totalMeasureUnit: totalMeasureUnit ?? this.totalMeasureUnit,
